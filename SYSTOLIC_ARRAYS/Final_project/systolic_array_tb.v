...
parameter WIDTH=8;
    ...
    wire out_img2col_sys_valid;
    wire out_systolic_array_done;
    wire empty1;
    wire empty2;
    wire empty3;
    
    wire [15:0] out_systolic_array_ai_img;
    ...
    initial begin
        $dumpfile("dump.vcd");
        $dumpvars;
        $monitor("Output 1:%d      Output 2:%d      Output 3:%d      Output Img:%d    Time:%0t", out_systolic_array_ai_out1, out_systolic_array_ai_out2, out_systolic_array_ai_out3,out_systolic_array_ai_img, $time);
        ...
        in_systolic_array_start = 1;

        send_matrixA_B(1,2,3, 4,5,6, 7,8,9,  3,5,1, 5,3,7, 1,7,3);
        send_matrixA_B(10,11,12, 13,14,16, 17,18,19,  3,5,1, 5,3,7, 1,7,3);
        send_matrixA_B(1,2,3, 4,5,6, 7,8,9,  3,5,1, 5,3,7, 1,7,3);
        send_matrixA_B(1,2,3, 4,5,6, 7,8,9,  3,5,1, 5,3,7, 1,7,3);
        send_matrixA_B(10,11,12, 13,14,16, 17,18,19,  3,5,1, 5,3,7, 1,7,3);
        send_matrixA_B(1,2,3, 4,5,6, 7,8,9,  3,5,1, 5,3,7, 1,7,3);
